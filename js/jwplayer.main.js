window.jwplayer = function (e) {
    ...
    [
        ...
        function (e, t, n) {
            var i, r;
            i = [], r = function () {
        var e = {}, t = Array.prototype, n = Object.prototype, i = Function.prototype, r = t.slice, o = t.concat, a = n.toString, s = n.hasOwnProperty, l = t.map, u = t.reduce, c = t.forEach, d = t.filter, f = t.every, p = t.some, h = t.indexOf, g = Array.isArray, v = Object.keys, m = i.bind, y = function P(e) {
    ...
    i = [n(3), n(4), n(1), n(2)], r = function (e, t, n, i) {
        ...
        var l = t.touchEvents, u = "PointerEvent" in window, c = "ontouchstart" in window, d = !(u || c && i.isMobile()), f = i.isFF() && i.isOSX(), p = function (e, t) {
            function i(e) {
            ...
            var w, E, b = e, A = !1, C = 0, k = 0, L = 0, P = 300;
                    ...
                    if (d > 0) {
                        ...
                        if ("PRIV" === r.value.key) {
                            if ("com.apple.streaming.transportStreamTimestamp" === p) {
                                var h = 1 & t.syncSafeInt(a.subarray(u, u += 4)), g = t.syncSafeInt(a.subarray(u, u += 4));
        ...
        var i = {}, r = {NEW: 0, LOADING: 1, ERROR: 2, COMPLETE: 3}, o = function (o, a) {
            ...
            this.addEventListener = this.on, this.removeEventListener = this.off, this.makeStyleLink = function (e) {
                ...
                if (c === r.NEW) {
                    ...
                    var n = document.getElementsByTagName("head")[0] || document.documentElement, u = this.makeTag(o), d = !1;
    ...
    i = [n(2), n(45), n(99), n(1), n(3), n(117), n(4), n(5)], r = function (e, t, n, i, r, o, a, s) {
        var l = function () {
            ...
            function c() {
                var t = !p.get("advertising") || p.get("advertising").autoplayadsmuted, n = l() && (e.isSafari() || e.isChrome() || e.isFacebook()), i = e.isAndroid() && e.isChrome(), r = n || i, o = 1 === p.get("sdkplatform");
    ...
    i = function () {
        ...
        function n(n, r, o) {
            var a = this;
            a.hasBeenReset = !1;
            var s = "", l = !1, u = n, c = r, d = o, f = null, p = "", h = !0, g = "auto", v = "start", m = 50, y = "middle", w = 50, E = "middle";
    ...
    i = [n(113), n(1)], r = function (e, t) {
        var n = function () {
            var n = {}, i = {}, r = {}, o = {}, a = Math.max(1, (new Date).getTime());
            return {
                start: function (t) {
                    ...
                    for (var l in n)if (Object.prototype.hasOwnProperty.call(n, l)) {
                        var u = a + e.now(), c = u - n[l];
                        s[l] = s[l] + c || c
                    }
                    return {counts: t.extend({}, r), sums: s, events: t.extend({}, o)}
                }, tick: function (t) {
                    o[t] = a + e.now()
    ...
    i = function (require, e, t) {
        ...
        function i(e, t) {
            ...
            if (n)if (t) {
                ...
                for (var o = Object.keys(n), a = 0; a < o.length; a += 1)for (var s = n[o[a]], l = 0; l < s.parts.length; l += 1)s.parts[l]();
                delete c[e]
            }
        }
    ...
    i = [n(37), n(54), n(1), n(45)], r = function (e, t, n, i) {
        ...
        var s = function (e, i) {
            var r = e.sources, a = i.get("androidhls"), s = e.drm || i.get("drm"), l = e.preload || i.get("preload"), u = o(e.withCredentials, i.get("withCredentials")), c = i.get("hlsjsdefault");
    ...
    i = [n(4), n(5), n(3), n(2), n(39), n(1), n(160), n(85), n(86), n(88), n(28)], r = function (e, t, n, i, r, o, a, s, l, u, c) {
        var d = function (d, f) {
            ...
            o.extend(this, n), this.utils = i, this._ = o, this.Events = n, this.version = c, this.trigger = function (e, t) {
                ...
                return n.triggerSafe.call(h, e, t)
    ...
    r = [n(89), n(96), n(1), n(92), n(93), n(33), n(101), n(53), n(52), n(2), n(81), n(3), n(34), n(5), n(4), n(141), n(95)], o = function (e, t, n, i, r, o, s, u, c, d, f, p, h, g, v, m, y) {
        ...
        return b.prototype = {
            ...
            setup: function (o, m) {
                ...
                function b(e, t) {
                    ye.trigger(v.JWPLAYER_CONTROLS, {controls: t})
                }
                ...
                function C() {
                    ge.change("visibility", k), ge.on("change:controls", b), ye.trigger(v.JWPLAYER_READY, {setupTime: 0}), ye.triggerAfterReady = ye.trigger;
                ...
                function P() {
                    j(), we = {bail: !1}, ge.once("itemReady", _, we)
                }
                ...
                function R(e, t) {
                    ye.trigger("viewable", {viewable: t})
                }

                function x(e, t) {
                    ge.get("playOnViewable") && (t ? Y() : d.isMobile() && ye.pause({reason: "autostart"}))
                }

                function T(e) {
                    var t = ge.getProviders(), n = t.required(e, ge.get("primary"));
                ...
                function S() {
                    for (; ye.eventsQueue.length > 0;) {
                        var e = ye.eventsQueue.shift(), t = e[0], n = e[1] || [];
                        ye["_" + t].apply(ye, n)
                    }
                }
                ...
                function N() {
                    ...
                    if (j(), ge.set("playReason", e.reason), ge.get("state") !== g.ERROR) {
                        ...
                        if (ge.get("state") === g.COMPLETE && (F(!0), H(0)), !ve && (ve = !0, ye.triggerAfterReady(v.JWPLAYER_MEDIA_BEFOREPLAY, {playReason: ge.get("playReason")}), ve = !1, he))return he = !1, void(pe = null);
                        var i;
                        if (J()) {
                ...
                function U(e, t) {
                    ge.set("feedData", t);
                    var i = u(e);
                    return i = u.filterPlaylist(i, ge, t), ge.set("playlist", i), n.isArray(i) && 0 !== i.length ? (T(i), !0) : (ye.triggerError({message: "Error loading playlist: No playable sources found"}), !1)
                }
                ...
                function q() {
                    if (J()) {
                        ...
                        pe = q;
                        var e = ge.get("item");
                        return e === ge.get("playlist").length - 1 ? void(ge.get("repeat") ? G({reason: "repeat"}) : (d.isIOS() && le(!1), ge.set("playOnViewable", !1), ge.set("state", g.COMPLETE), ye.trigger(v.JWPLAYER_PLAYLIST_COMPLETE, {}))) : void G({reason: "playlist"})
                    }
                }
                ...
                var ce, de, fe, pe, he, ge = this._model, ve = !1, me = !1, ye = this, we = {}, Ee = function () {
                    return ge.getVideo()
                }, be = new s;
                be.track(ge);
                var Ae = new e(o, be), Ce = [];
                ge.setup(Ae, be), ce = this._view = new f(m, ge), fe = new i(m, ge, ce, U), fe.on(v.JWPLAYER_READY, A, this), fe.on(v.JWPLAYER_SETUP_ERROR, this.setupError, this), ge.mediaController.on("all", w, this), ge.mediaController.on(v.JWPLAYER_MEDIA_COMPLETE, function () {
                    ...
                    var n = !!e.get("flashThrottle"), i = {message: n ? "Click to run Flash" : "Flash plugin failed to load"};
                    ...
                    ye.trigger(v.JWPLAYER_FULLSCREEN, {fullscreen: t}), t && e.set("playOnViewable", !1)
                    ...
                    if (t.length) {
                        var i = {playlist: t}, r = ge.get("feedData");
                        if (r) {
                            var o = n.extend({}, r);
                    ...
                    ye.trigger(v.JWPLAYER_MEDIA_VOLUME, {volume: t})
                }), ge.on("change:mute", function (e, t) {
                    ye.trigger(v.JWPLAYER_MEDIA_MUTE, {mute: t})
                }), ge.on("change:playbackRate", function (e, t) {
                    ye.trigger(v.JWPLAYER_PLAYBACK_RATE_CHANGED, {playbackRate: t, position: e.get("position")})
                }), ge.on("change:scrubbing", function (e, t) {
                    t ? W() : N({reason: "interaction"})
                }), ge.on("change:captionsList", function (e, t) {
                    ye.triggerAfterReady(v.JWPLAYER_CAPTIONS_LIST, {tracks: t, track: ge.get("captionsIndex") || 0})
                    ...
                    var a = {
                        ...
                        id: r,
                        btnClass: o
                    }, s = !1, l = n.map(ge.get("dock"), function (e) {
                        var t = e !== a && e.id === a.id;
                        return t ? (s = !0, a) : e
                    });
                    ...
                    var t = ge.get("dock") || [];
                    t = n.reject(t, n.matches({id: e})), ge.set("dock", t)
            ...
            setupError: function (e) {
                var t = e.message, i = d.createElement(m(this._model.get("id"), this._model.get("skin"), t)), r = this._model.get("width"), o = this._model.get("height");
                d.style(i, {
    ...
    i = [n(98), n(97), n(4), n(5), n(2), n(3), n(1)], r = function (e, t, n, i, r, o, a) {
        ...
        var l = {
            ...
            var h, g, v, m, y, w = s(o), E = new w(e, o), b = 0, A = {}, C = this, k = a.bind(function (e) {
    ...
    i = [n(39), n(1)], r = function (e, t) {
        ...
        var o = "playlistItem", a = "playAttempt", s = "providerFirstFrame", l = "firstFrame", u = "time", c = "tabHidden", d = "tabVisible", f = function (e) {
            var t = 0;
            return function (n) {
                var i = n.position;
                i > t && e(), t = i
    ...
    i = [n(21), n(52), n(15), n(65), n(22), n(1), n(2), n(4), n(50)], r = function (e, t, i, r, o, a, s, l, u) {
        function c() {
            var e = {
                ...
                FILTER_PLAYLIST: {method: E, depends: ["LOAD_PLAYLIST", "CHECK_FLASH"]},
    ...
    i = [n(7)], r = function (e) {
        ...
        return function (r) {
            ...
            for (var c = 0; c < a.length; c++) {
                ...
                var g = d.innerHTML || d.textContent || d.text || "", v = e.trim(g).replace(/>\s+</g, "><").replace(/(<\/?)tts?:/g, "$1").replace(/<br.*?\/>/g, "\r\n");
                if (v) {
                    var m = d.getAttribute("begin"), y = d.getAttribute("dur"), w = d.getAttribute("end"), E = {
                        begin: i(m, s),
                        text: v
                    };
    ...
    i = [n(20), n(7), n(2)], r = function (e, t, n) {
        ...
        var r = t.xmlAttribute, o = e.localName, a = e.textContent, s = e.numChildren, l = "media", u = function c(e, t) {
            function u(e) {
                var t = {
                    zh: "Chinese",
                    nl: "Dutch",
    ...
    i = [n(10), n(44), n(110), n(1), n(114)], r = function (e, t, i, r, o) {
        ...
        return r.extend(a.prototype, {
            load: function (e) {
                ...
                var n = r.clone(t);
                if ("flash" === e) {
                    var i = r.indexOf(n, r.findWhere(n, {name: "flash"})), o = n.splice(i, 1)[0], a = r.indexOf(n, r.findWhere(n, {name: "html5"}));
                    n.splice(a, 0, o)
                }
                return n
            }, providerSupports: function (e, t) {
    ...
    var i, r;
    i = [], r = function () {
        var e = window.performance, t = !(!e || !e.now), n = 1e4, i = function () {
            return t ? e.now() : (new Date).getTime()
        }, r = function () {
            var e = i(), t = e, r = function () {
                var e = i() - t;
                e > n ? e = n : e < 0 && (e = 0), t += e
            };
        ...
        return a = function (r) {
            ...
            function u() {
                ...
                if (e) {
                    ...
                    r.get("renderCaptionsNatively") ? p(r.get("id"), t) : s(b, {fontSize: t + "px"})
                }
            }
    ...
    function r(e, t) {
        var n = Math.max(e.top, t.top), i = Math.min(e.bottom, t.bottom), r = Math.max(e.left, t.left), o = Math.min(e.right, t.right), a = o - r, s = i - n;
    ...
    var r, o, a = n(155), s = i(a), l = n(145), u = n(150), c = i(u), d = n(151), f = i(d), p = n(62), h = i(p), g = n(68), v = n(146), m = void 0;
    r = [n(4), n(5), n(3), n(2), n(1), n(149), n(148), n(147), n(120), n(142), n(143), n(144), n(50)], o = function (e, t, i, r, o, a, u, d, p, y, w, E, b) {
        function A(A, _) {
            ...
            function K(e, t) {
                r.toggleClass(e, "jw-flag-fullscreen", t), C(document.body, {overflowY: t ? "hidden" : ""}), t && Ee && Ee.userActive(), z(), x()
            }
            ...
            var re = r.createElement((0, s["default"])(_.get("id"), _.get("localization").player)), oe = re.querySelector(".jw-media"), ae = new w(_), se = new E(_), le = new p(_), ue = void 0, ce = void 0, de = void 0, fe = void 0, pe = void 0, he = -1, ge = -1, ve = void 0, me = void 0, ye = void 0, we = null, Ee = void 0;
            this.updateBounds = function () {
                ...
                var t = _.get("id"), n = _.get("skinColorActive"), i = _.get("skinColorInactive"), o = _.get("skinColorBackground");
    ...
    i = [n(79), n(16), n(1), n(2), n(66), n(100), n(29)], r = function (e, t, i, r, o, a, s) {
        ...
        function u(e, n) {
            var r = i.clone(n.get("plugins")) || {}, a = n.get("edition"), s = t(a), u = /^(vast|googima|freewheel)$/, c = /\.(js|swf)$/, d = o.repo(), f = i.clone(n.get("advertising"));
...
jwplayer().registerPlugin("ping", "7.0", function (e) {
    ...
    e.on("playlistItem", function () {
        e.off("play", null, o), n = e.getPlaylistItem(), i = n.mediaid, i && e.once("play", function () {
            t = new Image, t.src = "/ping.gif?event=item&file=" + encodeURIComponent(n.file) + "&mediaid=" + encodeURIComponent(i) + "&r=" + Math.random()
        }, o)
    })
});
jwplayer.defaults = {
    ...
    "height": 270,
    // "key": "vUYb0wug4WPY2WJxvzoKm/u5Gk//M2dtrcmEwqiIGPpSJpyIEG9eMpYt/rQ=",
    "key": "123----vUYb0wug4WPY2WJxvzoKm/u5Gk//M2dtrcmEwqiIGPpSJpyIEG9eMpYt/rQ=",
    "mute": false,
    "ph": 1,
    "pid": "jwplayer.main",
    "plugins": {
