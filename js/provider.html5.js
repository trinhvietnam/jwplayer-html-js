webpackJsonpjwplayer([5], {
    8: function (e, t, i) {
        ...
        r = [i(1), i(11), i(2), i(13), i(12)], a = function (e, t, i, r, a) {
                ...
                if (this._currentTextTrackIndex = -1, t) {
                    if (this._textTracks ? (this._textTracks = e.reject(this._textTracks, function (e) {
                        ...
                        for (r; r < n; r++) {
                            ...
                            if (s.inuse && !this._tracksById[s._id])if ("metadata" === s.kind) s.mode = "hidden", s.oncuechange = L.bind(this), this._tracksById[s._id] = s; else if (E(s.kind)) {
                                var o, d = s.mode;
            ...
            function d(e) {
                if (e.text && e.begin && e.end) {
                    var t = e.trackid.toString(), i = this._tracksById && this._tracksById[t];
                    i || (i = {
                        kind: "captions",
                        _id: t,
                        data: []
                    ...
                    if (!n) {
                        n = {begin: e.begin, end: e.end, text: e.text}, this._metaCuesByTextTime[a] = n;
            ...
            function u(e) {
                ...
                var t = e.track ? e.track : "native" + e.type, i = this._tracksById[t], r = "captions" === e.type ? "Unknown CC" : "ID3 Metadata", a = e.cue;
                if (!i) {
                    var n = {kind: e.type, _id: t, label: r, embedded: !0};
            ...
            function l(e) {
                ...
                if (t) {
                    ...
                    for (var i = e.captions || [], a = [], n = !1, s = 0; s < i.length; s++) {
                        var c = i[s], o = e.name + "_" + c.begin + "_" + c.end;
            ...
            function y() {
                var t = this.video.textTracks, i = e.filter(t, function (e) {
                    return (e.inuse || !e._id) && E(e.kind)
                });
                if (!this._textTracks || S.call(this, i))return void this.setTextTracks(t);
                for (var r = -1, a = 0; a < this._textTracks.length; a++)if ("showing" === this._textTracks[a].mode) {
                    r = a;
                    break
                }
            ...
            function I(t) {
                var i, r = a.createLabel(t, this._unknownCount), n = r.label;
                if (this._unknownCount = r.unknownCount, this.renderNatively || "metadata" === t.kind) {
                    var s = this.video.textTracks;
                    i = e.findWhere(s, {label: n}), i ? (i.kind = t.kind, i.language = t.language || "") : i = this.video.addTextTrack(t.kind, n, t.language || ""), i["default"] = t["default"], i.mode = "disabled", i.inuse = !0
                ...
                if (r && r.length) {
                    ...
                    if (this._activeCuePosition !== a) {
                        ...
                        if (e.each(r, function (e) {
                            ...
                            var s = t.parseID3(n);
                            this.trigger("meta", {metadataTime: a, metadata: s})
                        }
            ...
            function R(e, t) {
                ...
                switch (i) {
                    ...
                    case"subtitles":
                        ...
                        var n = "_" + t.line, s = Math.floor(20 * t.endTime), c = a[r + n] || a[r + 1 + n] || a[r - 1 + n];
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), t.qualityLevel = i
    }, 24: function (e, t, i) {
        var r, a;
        r = [], a = function () {
            function e(e) {
        ...
        r = [i(109), i(63), i(4), i(1)], a = function (e, t, i, r) {
            function a(e, a) {
                function l(i) {
                    ...
                    u.initData = c, t.ajax(u.certificateUrl, function (e) {
                        var t = new Uint8Array(e.response), i = u.extractContentId(d(c));
                        r.isString(i) && (i = o(i));
                        var l = n(c, i, t), h = a.webkitKeys.createSession("video/mp4", l);
                ...
                function f(t) {
                    var i = e.fairplay, a = t.target, n = t.message, s = new XMLHttpRequest;
                ...
                function T(t) {
                    var i = t.target, a = e.fairplay.extractKey(i.response);
                    r.isFunction(a.then) ? a.then(k) : k(a)
                }

                function k(t) {
                    var i = e.fairplay.session, a = t;
                    r.isString(a) && (a = u(a)), i.update(a)
                }

                function g() {
                    e.trigger(i.JWPLAYER_MEDIA_ERROR, {message: "Error loading media: Failed to retrieve the server certificate"})
                }

                function v() {
                    e.trigger(i.JWPLAYER_MEDIA_ERROR, {message: "Error loading media: Decryption key error was encountered"})
                }

                function y() {
                    e.trigger(i.JWPLAYER_MEDIA_ERROR, {message: "Error loading media: The license request failed"})
                }
            ...
            function n(e, t, i) {
                var r = 0, a = new ArrayBuffer(e.byteLength + 4 + t.byteLength + 4 + i.byteLength), n = new DataView(a), s = new Uint8Array(a, r, e.byteLength);
            ...
            var l = function (t, i) {
                e.call(this, t, i);
                var r = this.init, n = this.load, s = this.destroy;
        ...
        r = [i(60), i(23), i(2), i(14), i(1), i(4), i(5), i(10), i(3), i(8), i(24)], a = function (e, t, i, r, a, s, c, o, d, u, l) {
            ...
            function T(o, T) {
                ...
                function P() {
                    Ae.trigger("ratechange", {playbackRate: Ge.playbackRate})
                }
                ...
                function G() {
                    Ae.trigger(s.JWPLAYER_MEDIA_ERROR, {message: "Error loading media: File could not be played"})
                }
                ...
                function X(e) {
                    Ie = e, Be = z(e);
                    var t = Q(e);
                    t && Ae.trigger(s.JWPLAYER_MEDIA_LEVELS, {levels: t, currentQuality: Be})
                }

                function z(e) {
                    var t = Math.max(0, Be), i = T.qualityLabel;
                ...
                function $(e, t) {
                    ...
                    r.src = Ie[Be].file;
                    var a = Ge.src !== r.src, n = Ge.getAttribute("jw-loaded"), s = Ge.hasAttribute("jw-played");
                ...
                function te() {
                    Ge && (Ae.disableTextTrack(), Ge.removeAttribute("preload"), Ge.removeAttribute("src"), Ge.removeAttribute("jw-loaded"), Ge.removeAttribute("jw-played"), r.emptyElement(Ge), t.style(Ge, {objectFit: ""}), Be = -1, !m && "load" in Ge && Ge.load())
                }
                ...
                function ne() {
                    Ae.trigger("volume", {volume: Math.round(100 * Ge.volume)}), Ae.trigger("mute", {mute: Ge.muted})
                }
                ...
                function ce() {
                    var e = Ge.buffered, t = Ge.duration;
                ...
                function ue() {
                    for (var e = -1, t = 0; t < Ge.audioTracks.length; t++)if (Ge.audioTracks[t].enabled) {
                        e = t;
                        break
                    }
                    Te(e)
                ...
                function he(e) {
                    Ae.trigger("fullscreenchange", {target: e.target, jwstate: Ne})
                }
                ...
                function ve() {
                    if ("hls" === Ie[0].type) {
                        var e = "video";
                        0 === Ge.videoHeight && (e = "audio"), Ae.trigger("mediaType", {mediaType: e})
                    }
                }

                function ye() {
                    var e = l.endOfRange(Ge.buffered), t = Ge.duration === 1 / 0;
                ...
                function _e() {
                    return !(!qe || !Ve) && (Ae.trigger(s.JWPLAYER_MEDIA_ERROR, {message: "The live stream is either down or has ended"}), !0)
                }
                ...
                }, Le = !1, Re = 0, Se = -1, Me = -1, Be = -1, De = null, Pe = !!T.sdkplatform, Ne = !1, Fe = i.noop, Oe = null, je = -1, He = {level: {}}, We = !1, Ue = 3e4, Ye = null, Je = null, qe = !1, Ve = !1, Ke = document.getElementById(o), Ge = Ke ? Ke.querySelector("video, audio") : void 0;
                Ge || (Ge = document.createElement("video"), p && C("jw-gesture-required")), Ge.className = "jw-video jw-reset", this.isSDK = Pe, this.video = Ge, this.supportsPlaybackRate = !0, h(Ce, Ge), C("disableRemotePlayback", ""), C("webkit-playsinline"), C("playsinline"), this.stop = function () {
                    ...
                    pe(), Ge.pause(), Fe = function () {
                        ...
                        if (e && Ge.duration === 1 / 0) {
                            var t = re(), i = t - ie(), r = i < v, a = t - Ge.currentTime;
                    ...
                    e = !!e, e || x ? t.style(be, {visibility: "visible", opacity: 1}) : t.style(be, {
                            visibility: "",
                            opacity: 0
                        })
                }, this.resize = function (e, i, r) {
                    if (!(e && i && Ge.videoWidth && Ge.videoHeight))return !1;
                    var a = {objectFit: "", width: "", height: ""};
                    if ("uniform" === r) {
                        var n = e / i, s = Ge.videoWidth / Ge.videoHeight;
                        Math.abs(n - s) < .09 && (a.objectFit = "fill", r = "exactfit")
                    }
                    var c = y || E || w || x && !b;
                    if (c) {
                        var o = -Math.floor(Ge.videoWidth / 2 + 1), d = -Math.floor(Ge.videoHeight / 2 + 1), u = Math.ceil(100 * e / Ge.videoWidth) / 100, l = Math.ceil(100 * i / Ge.videoHeight) / 100;
                    ...
                    if (Be !== e && e >= 0 && Ie && Ie.length > e) {
                        ...
                        var t = Ge.currentTime || 0, i = Ge.duration || 0;
            ...
            var k = window.clearTimeout, g = 256, v = 120, y = i.isIE(), _ = i.isIE(9), m = i.isMSIE(), p = i.isMobile(), b = i.isFF(), x = i.isAndroidNative(), E = i.isIOS(7), w = i.isIOS(8), I = "html5", A = function () {
            };
