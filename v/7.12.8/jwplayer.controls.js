webpackJsonpjwplayer([1], {
    41: function (e, t, i) {
        ...
        a = [i(3), i(6), i(2), i(1)], l = function (e, t, i, n) {
            var a = function (e) {
                var t = i.bounds(e), n = window.pageXOffset;
            ...
            return function () {
                ...
                return r(l, [{
                    ...
                    key: "dragMove", value: function (e) {
                        var t = this.railBounds = this.railBounds ? this.railBounds : a(this.elementRail), n = void 0, o = void 0;
        ...
        o = [i(3), i(64), i(2), i(1)], a = function (e, t, i, o) {
            return function () {
                ...
                return l(a, [{
                    ...
                    key: "openTooltip", value: function (e) {
                        this.trigger("open-" + this.componentType, e, {isOpen: !0}), this.isOpen = !0, i.toggleClass(this.el, this.openClass, this.isOpen)
                    }
                }, {
                    key: "closeTooltip", value: function (e) {
                        this.trigger("close-" + this.componentType, e, {isOpen: !1}), this.isOpen = !1, i.toggleClass(this.el, this.openClass, this.isOpen)
                    }
                }, {
                    key: "toggleOpenState", value: function (e) {
        ...
        r = [i(42), i(2), i(1), i(6)], s = function (e, t, i, n) {
            return function (e) {
                ...
                return l(r, e), c(r, [{
                    key: "setup", value: function (e, o, a) {
                        ...
                        var l = e.length > 2 || 2 === e.length && a && a.isToggle === !1, r = !l && 2 === e.length;
                        if (t.toggleClass(this.el, "jw-toggle", r || a.isToggle), t.toggleClass(this.el, "jw-button-color", !r), l) {
                            ...
                            var s = (0, u["default"])(e), c = t.createElement(s);
                    ...
                    key: "toggleValue", value: function () {
                        this.trigger("toggleValue")
                    }
                }, {
                    key: "select", value: function (e) {
                        if (e.target.parentElement === this.content) {
                            var n = t.classList(e.target), o = i.find(n, function (e) {
                    ...
                    key: "selectItem", value: function (e) {
                        if (this.content)for (var i = 0; i < this.content.children.length; i++)t.toggleClass(this.content.children[i], "jw-active-option", e === i);
        ...
        o = [i(4), i(5), i(3), i(22), i(2), i(1), i(70), i(126), i(128), i(127), i(132), i(131), i(129), i(130), i(175)], a = function (e, t, o, a, r, s, c, w, u, d, p, j, h, g, f) {
            var m = r.isMobile() ? 4e3 : 2e3, y = function () {
            ...
            return function () {
                ...
                return l(t, [{
                    key: "enable", value: function (t, i) {
                        function n(e) {
                            var n = 0, o = i.get("duration"), l = i.get("position");
                        ...
                        var l = this, s = this.context.createElement("div");
                        s.className = "jw-controls jw-reset", this.div = s;
                        var m = i.get("touchMode");
                        if (!this.displayContainer) {
                            var b = new d, v = new p(i, t), k = new j(i), x = new h(i, t);
                        ...
                        var M = function (e) {
                            ...
                            switch (l.instreamState || l.userActive(), e.keyCode) {
                                ...
                                case 40:
                                    ...
                                    break;
                                case 67:
                                    var a = t.getCaptionsList(), r = a.length;
                                    if (r) {
                                ...
                                default:
                                    if (e.keyCode >= 48 && e.keyCode <= 59) {
                                        var c = e.keyCode - 48, w = c / 10 * i.get("duration");
                                        t.seek(w, y())
                                    }
                            }
                    ...
                    key: "logoContainer", value: function () {
                        return this.right
                    }
                }, {
                    ...
                    key: "unmuteAutoplay", value: function (e, t) {
                        var i = !t.get("autostartFailed"), n = t.get("mute");
                    ...
                    key: "addActiveListeners", value: function (e) {
                    ...
                    key: "removeActiveListeners", value: function (e) {
                    ...
                    key: "userActive", value: function (e) {
                        var t = this;
                    ...
                    key: "userInactive", value: function () {
                        clearTimeout(this.activeTimeout), this.showing = !1, this.controlbar && this.controlbar.closeMenus({type: "userInactive"}), r.addClass(this.playerContainer, "jw-flag-user-inactive"), this.trigger("userInactive")
                    }
                }]), t
            }()
        }.apply(t, o), !(void 0 !== a && (e.exports = a))
        ...
        o = [i(1), i(2), i(35)], a = function (e, t, i) {
            ...
            return {
                loadChapters: function (e) {
                    ...
                    var t = this, i = this._model.get("duration");
        ...
        r = [i(71), i(2)], s = function (e, t) {
            return function (e) {
                function i(e, n, l) {
                    o(this, i);
                    var r = a(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, e, n, !1)), s = (0, d["default"])(l), c = t.createElement(s);
                ...
                return l(i, e), c(i, [{
                    key: "setup", value: function (e, n, o) {
        ...
        n = [i(1), i(2), i(35)], o = function (e, t, i) {
            ...
            return {
                loadThumbnails: function (e) {
                    ...
                    var i = e.sortedIndex(this.thumbnails, {end: t}, e.property("end"));
                    ...
                    var i = this.chooseThumbnail(t), n = {
                        display: "block",
                        margin: "0 auto",
            ...
            var j = function (e) {
                ...
                return a(w, r), c(w, [{
                    ...
                    key: "limit", value: function (t) {
                        ...
                        var n = this._model.get("duration"), o = this._model.get("streamType");
                        if ("DVR" === o) {
                            var a = (1 - t / 100) * n, l = this._model.get("position"), r = Math.min(a, Math.max(i.dvrSeekLimit, l)), s = 100 * r / n;
                            return 100 - s
                        }
                        return t
                    }
                    ...
                    key: "onBuffer", value: function (e, t) {
                        this.updateBuffer(t)
                    }
                }, {
                    key: "onPosition", value: function (e, t) {
                        return this.dragJustReleased ? void(this.dragJustReleased = !1) : void this.updateTime(t, e.get("duration"))
                    }
                }, {
                    key: "onDuration", value: function (e, t) {
                    ...
                    key: "onPlaylistItem", value: function (t, i) {
                        if (i) {
                    ...
                    key: "performSeek", value: function () {
                        var e, t = this.seekTo, i = this._model.get("duration"), n = this._model.get("streamType");
                        0 === i ? this._api.play(p()) : "DVR" === n ? (e = (100 - t) / 100 * i, this._api.seek(e, p())) : (e = t / 100 * i, this._api.seek(Math.min(e, i - .25), p()))
                    }
                }, {
                    key: "showTimeTooltip", value: function (n) {
                        var o = this._model.get("duration");
                        if (0 !== o) {
                            var a = this._model.get("containerWidth"), r = t.bounds(this.elementRail), s = n.pageX ? n.pageX - r.left : n.x;
                            s = t.between(s, 0, r.width);
                            var c = s / r.width, w = o * c;
                            o < 0 && (w = o - w);
                            var u;
                            if ("touch" === l.getPointerType(n.sourceEvent) && (this.activeCue = e.reduce(this.cues, function (e, t) {
                                ...
                                }.bind(this), void 0)), this.activeCue) u = this.activeCue.text; else {
                                var d = !0;
                            ...
                            var j = p.getWidth(), h = r.width / 100, g = a - r.width, f = 0;
                            j > g && (f = (j - g) / (200 * h));
                    ...
                    key: "hideTimeTooltip", value: function () {
        ...
        o = [i(2), i(1), i(3), i(22), i(6), i(64), i(41), i(124), i(71), i(122), i(125), i(70)], a = function (e, t, i, o, a, s, c, w, u, d, p, j) {
            ...
            function f(t, i) {
                ...
                var n = i.cast, o = document.createElement("button", "google-cast-button");
            ...
            return function () {
                function s(l, u) {
                    ...
                    var b = new w(u, l), v = void 0, k = void 0, x = void 0, C = this._localization.play, _ = this._localization.next, T = this._localization.volume, E = this._localization.rewind;
                    ...
                    if (M) {
                        var L = M.indexOf(this._model.get("playbackRate")), I = M.map(function (e) {
                            return {label: e + "x", rate: e}
                        });
                ...
                return l(s, [{
                    key: "onCaptionsList", value: function (e, t) {
                        var i = e.get("captionsIndex");
                        this.elements.cc.setup(t, i, {isToggle: !0})
                    }
                }, {
                    key: "onCaptionsIndex", value: function (e, t) {
                        this.elements.cc.selectItem(t)
                    }
                }, {
                    key: "togglePlaybackRateControls", value: function (t) {
                    ...
                    key: "onPlaybackRate", value: function (e, t) {
                        this.elements.playbackrates.selectItem(e.get("playbackRateControls").indexOf(t))
                    }
                }, {
                    key: "onPlaylistItem", value: function () {
                        this.elements.audiotracks.setup()
                    }
                }, {
                    key: "onMediaModel", value: function (e, i) {
                        i.on("change:levels", function (e, t) {
                            ...
                            this.elements.audiotracks.setup(n, e.get("currentAudioTrack"), {isToggle: !1})
                        }, this), i.on("change:currentAudioTrack", function (e, t) {
                            this.elements.audiotracks.selectItem(t)
                        }, this)
                    }
                }, {
                    key: "onVolume", value: function (e, t) {
                        this.renderVolume(e.get("mute"), t)
                    }
                }, {
                    key: "onMute", value: function (e, t) {
                        this.renderVolume(t, e.get("volume"))
                    }
                }, {
                    key: "renderVolume", value: function (t, i) {
                    ...
                    key: "onCastAvailable", value: function (e, t) {
                        this.elements.cast.toggle(t)
                    }
                }, {
                    key: "onCastActive", value: function (t, i) {
                        this.elements.fullscreen.toggle(!i), this.elements.cast.button && e.toggleClass(this.elements.cast.button, "jw-off", !i)
                    }
                }, {
                    key: "onElapsed", value: function (t, i) {
                        var n = void 0, o = void 0, a = t.get("duration");
                    ...
                    key: "rewind", value: function () {
                        var e = this._model.get("position"), t = this._model.get("duration"), i = e - 10, n = 0;
                        "DVR" === this._model.get("streamType") && (n = t), this._api.seek(Math.max(i, n), m())
                    }
                }, {
                    key: "onStreamTypeChange", value: function (e) {
                    ...
                    key: "onNextUp", value: function (e, t) {
            ...
            return function () {
                ...
                return r(l, [{
                    key: "click", value: function (e) {
                        var i = n(e), o = i.getAttribute("button"), a = this.model.get("dock"), l = t.findWhere(a, {id: o});
            ...
            return function () {
                ...
                return r(l, [{
                    key: "setup", value: function (e) {
                        ...
                        var n = this._model;
                        this.enabled = !1, n.on("change:nextUp", this.onNextUp, this), n.change("duration", this.onDuration, this), n.change("position", this.onElapsed, this), n.change("streamType", this.onStreamType, this), n.change("mediaModel", this.onMediaModel, this), new t(this.closeButton, {directSelect: !0}).on("click tap", function () {
                            this.nextUpSticky = !1, this.toggle(!1)
                        }, this), new t(this.tooltip).on("click tap", this.click, this)
                    }
                }, {
                    key: "loadThumbnail", value: function (e) {
                        return this.nextUpImage = new Image, this.nextUpImage.onload = function () {
                            this.nextUpImage.onload = null
                        }.bind(this), this.nextUpImage.src = e, {backgroundImage: 'url("' + e + '")'}
                    }
                }, {
                    ...
                    key: "setNextUpItem", value: function (t) {
                        var i = this;
                        setTimeout(function () {
                    ...
                    key: "onMediaModel", value: function (e, t) {
                        t.change("state", function (e, t) {
                            "complete" === t && this.toggle(!1)
                        }, this)
                    }
                }, {
                    key: "onElapsed", value: function (e, t) {
                    ...
                    key: "onStreamType", value: function (e, t) {
        ...
        a = [i(2), i(3), i(6), i(1)], l = function (e, t, i, n) {
            return function () {
                function a(l) {
                    ...
                    var s = l.get("localization"), w = e.createElement((0, c["default"])("display", s.playback)), u = w.getElementsByClassName("jw-icon-display")[0];
            ...
            return function () {
                function i(n, a) {
                    o(this, i), this.el = e.createElement((0, c["default"])("rewind", n.get("localization").playback)), this.iconUI = new t(this.el).on("click tap", function () {
                        var e = n.get("position"), t = n.get("duration"), i = e - 10, o = 0;
        ...
        a = [i(2), i(6), i(28)], l = function (e, t, i) {
            return function () {
                ...
                return r(n, [{
                    key: "buildArray", value: function () {
                        var t = i.split("+"), n = t[0], o = {
                            items: [{
                        ...
                        if (a && l) {
                            var r = l.split(".");
                            o.items.push({title: "build: (" + r[0] + "." + r[1] + ")", link: "#"})
                        }
                        var s = this.model.get("provider");
                        if (s && s.name.indexOf("flash") >= 0) {
                            var c = "Flash Version " + e.flashVersion();
                            o.items.push({title: c, link: "http://www.adobe.com/software/flash/about/"})
                        }
                        return o
                    }
                }, {
                    key: "rightClick", value: function (e) {
                    ...
                    key: "showMenu", value: function (t) {
                        var i = this, n = this.getOffset(t);
                        return this.el.style.left = n.x + "px", this.el.style.top = n.y + "px", e.addClass(this.playerElement, "jw-flag-rightclick-open"), e.addClass(this.el, "jw-open"), clearTimeout(this._menuTimeout), this._menuTimeout = setTimeout(function () {
                            return i.hideMenu()
                        }, 3e3), !1
                    }
                }, {
                    ...
                    key: "lazySetup", value: function () {
                        ...
                        } else this.html = i, this.el = e.createElement(this.html), this.layer.appendChild(this.el), this.hideMenuHandler = this.hideMenu.bind(this), this.addOffListener(this.playerElement), this.addOffListener(document), this.elementUI = new t(this.el, {useHover: !0}).on("over", function () {
                    ...
                    key: "removeOffListener", value: function (e) {
        ...
        var i = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", i = arguments[2], o = arguments[3], a = i ? 'style="background-image: url(' + i + ')"' : "", l = o ? n(o) : "", r = o ? 'aria-label="' + o + '" role="button" tabindex="0"' : "";
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = function (e) {
            var t = e.items, n = void 0 === t ? [] : t, o = n.map(function (e) {
                return i(e.link, e.title, e.featured, e.showLogo)
            }).join("");
            return '<div class="jw-rightclick jw-reset"><ul class="jw-reset">' + o + "</ul></div>"
        };
        var i = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", i = arguments[2], n = arguments[3], o = n ? '<span class="jw-icon jw-rightclick-logo jw-reset"></span>' : "";
