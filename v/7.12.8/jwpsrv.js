!function () {
    ...
    function e() {
        ...
        if (t) {
            var e = t.loadEventEnd || (new Date).getTime(), n = e - t.navigationStart;
    ...
    function f(t) {
        ...
        return e && e.level ? {width: e.level.width, height: e.level.height} : {width: null, height: null}
    }

    function l(t) {
        var e = t.getContainer().querySelector("video"), n = 0;
        if (e && (n = e.duration, e.buffered && e.buffered.length)) {
            var i = e.buffered.end(e.buffered.length - 1) || 0;
            return ti(10 * i) / 10
        }
        return n || (n = Math.abs(t.getDuration())), ti(n * t.getBuffer() / 10) / 10
    }

    function p() {
        var t = window.jwplayer, e = 0;
    ...
    function m(t) {
        var e = /.*\/(?:manifests|videos)\/([a-zA-Z0-9]{8})[\.-].*/, n = e.exec(t);
    ...
    function j(t, e, n) {
        ...
        if (t.getPlugin) {
            ...
            o && (o.on("playlist", i(D)), o.on("open", i(L)), o.on("play", i(M)), o.on("feedShown", function (t) {
                r = t.reason, q(t, e, n)
            ...
            t.on("playlistItem", function () {
                ...
                a = t.reason, ("hover" !== t.reason || u) && (u = !1, q(t, e, n))
    ...
    function M(t, e, n) {
        ...
        if ("item" in t) {
            var r;
            r = "play" === t.onclick ? t.item.mediaid : t.item.link, i.push(Kn(Ee, r, 17))
        }
        "autoplaytimer" in t && i.push(Kn(Be, t.autoplaytimer, 18)), B(st, t, i, e, n)
    }

    function q(t, e, n) {
        var i = t.feedData || {}, r = t.itemsShown || [], a = 0, o = r.map(function (t) {
            return C(t) && a++, I(t)
    ...
    function O(t, e) {
        var n = t.feedData || {}, i = t.itemsShown || [], r = t.target;
    ...
    function U(t, e, n, i) {
        if ("onclick" in i && n.push(Kn(De, "play" === i.onclick ? 1 : 0, 19)), "method" in i) {
            ...
            t === st ? r = qe : t === lt && (r = Fe), r && n.push(Kn(r, a, 20))
        }
        "method_group_id" in i && n.push(Kn(Le, i.method_group_id, 21)), "rec_id" in i && n.push(Kn(Me, i.rec_id, 22)), "position" in i && n.push(Kn(Oe, i.position + 1, 23));
        var o = T(i);
    ...
    function $() {
        ...
        if (t)return t;
        try {
            return yi.jwplayerLocalId = v(12), yi.jwplayerLocalId
        } catch (t) {
        }
        return null
    }
    ...
    var tt = "jwplayer6", et = "clienta", nt = "error", it = "e", rt = "pa", at = "s", ot = "t", ut = "ret", ct = "vs", dt = "vsh", st = "rc", ft = "bs", lt = "rs", pt = "fs", ht = "fc", vt = "aa", gt = "c", mt = "ed", wt = "d", kt = "ph", yt = "mu", bt = "t", Tt = "ti", Ct = "pw", St = "etw", Pt = "tb", It = "ps", _t = "vs", At = "wd", xt = "pl", Rt = "l", jt = "q", Dt = "m", Lt = "id", Mt = "fv", qt = "eb", Ft = "st", Et = "ff", Ot = "plt", Bt = "pp", Ut = "pgi", Vt = "prc", Qt = "stc", Ht = "emi", Xt = "pli", Nt = "fed", Wt = "fid", $t = "psd", zt = "vp", Zt = "po", Gt = "s", Jt = "r", Kt = "sn", Yt = "cb", te = "ga", ee = "pr", ne = "vd", ie = "mk", re = "tt", ae = "cct", oe = "drm", ue = "pd", ce = "at", de = "df", se = "tf", fe = "plc", le = "pid", pe = "dd", he = "cp", ve = "ab", ge = "pad", me = "mt", we = "vb", ke = "vi", ye = "vl", be = "rf", Te = "tvs", Ce = "set", Se = "pdt", Pe = "ccp", Ie = "aid", _e = "i", Ae = "pv", xe = "pu", Re = "pt", je = "sdk", De = "os", Le = "mgi", Me = "ri", qe = "rct", Fe = "rst", Ee = "rn", Oe = "oc", Be = "rat", Ue = "lid", Ve = "fin", Qe = "fis", He = "fns", Xe = "fpc", Ne = "fpg", We = "fsr", $e = "ft", ze = "fct", Ze = "abt", Ge = "pbr", Je = "pbd", Ke = "pbc", Ye = "vh", tn = "vw", en = "ubi", nn = "cvl", rn = "tvl", an = "vso", on = "sdt", un = "pyc", cn = "pii", dn = "stg", sn = "pss", fn = "v", ln = "adi", pn = "al", hn = "p", vn = "vv", gn = "ct", mn = "ad", wn = "du", kn = "tf", yn = "df", bn = "pc", Tn = "pi", Cn = "vu", Sn = "qt", Pn = "awi", In = "awc", _n = "ask", An = "abk", xn = "atk", Rn = "sko", jn = "abo", Dn = "uav", Ln = "vr", Mn = "vrt", qn = "cx", Fn = "o", En = "cs", On = "pip", Bn = "sv", Un = "bi", Vn = "an", Qn = "did", Hn = "dm", Xn = "sc", Nn = "ts", Wn = "ha", $n = "ers", zn = "err", Zn = "erc", Gn = function (t, e) {
    ...
    }(), ti = Math.round, ei = function (e, i, r, a, u) {
        function c(t, e) {
            u.track(t, et, e)
        }

        function d(t) {
            -1 === e.adClient && t && (e.adClient = g(t.client)), t.sequence !== S.podIndex && (delete S.timeAdLoading, delete S.adCreativeType), s(t, "adbreakid"), s(t, "adtagid"), s(t, "offset"), s(t, "witem"), s(t, "wcount"), s(t, "skipoffset"), s(t, "linear", function (t, e) {
                return e === t
            }), s(t, "adposition", function (t, e) {
                return {pre: 0, mid: 1, post: 2, api: 3}[e]
            ...
            }), t.timeLoading && (S.timeAdLoading = 10 * Math.round(t.timeLoading / 10)), t.universalAdIdRegistry && "unknown" !== t.universalAdIdRegistry ? S.universalAdId = t.universalAdIdRegistry + "." + t.universalAdIdValue : delete S.universalAdId, S.conditionalAd = t.conditionalAd, S.conditionalAdOptOut = !!t.conditionalAdOptOut, S.mediaFileCompliance = t.mediaFileCompliance, S.adSystem = t.adsystem || S.adSystem, S.vastVersion = t.vastversion || S.vastVersion, S.podIndex = t.sequence || S.podIndex, S.podCount = t.podcount || S.podCount
        }
        ...
        var w = {
            ...
            witem: 1,
            wcount: 1
        }, k = a.getConfig(), y = (k || {}).advertising || {};
        e.adClient = g(y.client), e.adScheduleId = y.adscheduleid;
        var S = null;
        a.on("adRequest adMeta adImpression adComplete adSkipped adError adTime", function (t) {
            S && S.adId === t.id && -1 !== t.id || (S = this._.extend({adId: t.id}, w))
    ...
    }, ni = {play: 1, api: 2, interaction: 3, complete: 4, auto: 5, manual: 6, link: 7}, ii = function (t, e, n) {
        e.on("ready", function () {
            j(e, t, n)
        })
    }, ri = .02, ai = 1, oi = 0, ui = {
        ...
        function t(e, n, i) {
            ...
            var a = i.ownerDocument || window.document, o = "complete" === a.readyState;
        ...
        return t.prototype.track = function (t, e, n) {
            var i = this.buildTrackingURL(t, e, n), r = !this.pageLoaded;
            if (!r || "i" !== t && "ar" !== t && "as" !== t) {
                if (r)return void this.queue.push(i)
            } else this.flushQueue();
            this.ping(i)
        }, t.prototype.buildTrackingURL = function (t, e, n) {
            var i = [Kn("e", t, 0), Kn("tv", "2.20.2", 1), Kn("n", Math.random().toFixed(16).substr(2, 16), 2)].concat(n);
            i.sort(function (t, e) {
                return t.priority - e.priority
            });
            for (var r, a = [], o = 0; o < i.length; o++)r = i[o].value, !0 === r || !1 === r ? r = r ? 1 : 0 : (null === r || void 0 === r) && (r = ""), a.push(i[o].key + "=" + encodeURIComponent(r));
            var u = "file:" === window.location.protocol ? "https:" : "", c = a.join("&");
            return "/player/ping.gif?h=" + di(c) + "&" + c
        ...
        var n, i = 0;
        if (t) {
            var r = new e(t), a = r.edition();
            4 !== (i = fi[a] || 0) && (n = r.token())
        }
        n || (n = "_");
        var o = {};
        return o[Ie] = n, o[mt] = i, o
    }, pi = function () {
        ...
        if (t)return {};
        var e = "", n = "", i = window.top !== window.self;
        if (i) {
            e = document.referrer;
            try {
        ...
        var r = {};
        return r[xe] = e || window.location.href, r[Re] = n || document.title, r[_e] = i, r[Mt] = pi(), r
    }, vi = function (t, e, n) {
        var i = {};
        return i[Ae] = w(t.version), i[je] = e.sdkplatform || 0, i[Ht] = v(12), n && (i[Qn] = e.mobiledeviceid, i[Bn] = e.iossdkversion, i[Hn] = e.mobiledevicemodel, i[Un] = e.bundleid, i[Vn] = e.applicationname, i[Xn] = e.systemcaptions, i[Nn] = e.texttospeech, i[Wn] = e.hardwareacceleration), i
    }, gi = function (t) {
        var e = {}, n = window.jwplayer ? window.jwplayer.defaults || {} : {};
        e[kt] = t[kt] || n[kt] || 0, e[le] = t.pid, e[ge] = t.pad, e[Kt] = t.skin, e[ve] = !!t.advertising, e[Gt] = !!t.sharing, e[Yt] = !!t.cast, e[te] = !!t.ga, e[wt] = !!t.autostart, e[Dt] = 1, e[zt] = !1 !== t.visualplaylist, e[pe] = !1 !== t.displaydescription, e[Zt] = !!t.image, e[Ke] = !!t.playbackRateControls;
        var i = t.related;
        return e[Jt] = !!i, i && (e[be] = i.recommendations || i.file), e
    }, mi = Math.round, wi = function (t) {
        var e = t.getConfig(), n = e.containerWidth || t.getWidth(), r = e.containerHeight || t.getHeight();
        if (/\d+%/.test(n)) {
            var a = t.utils.bounds(t.getContainer());
            n = a.width, r = a.height
        }
        return n = 0 | mi(n), r = 0 | mi(r), /\d+%/.test(e.width || n) && e.aspectratio ? {
                bucket: 4,
                width: n,
                height: r
            } : i(t.getContainer(), "jw-flag-audio-player") ? {bucket: 5, width: n, height: r} : 0 === n ? {
                        bucket: 0,
                        width: n,
                        height: r
                    } : 320 >= n ? {bucket: 1, width: n, height: r} : 640 >= n ? {
                                bucket: 2,
                                width: n,
                                height: r
                            } : {bucket: 3, width: n, height: r}
    }, ki = function (t, e, n) {
    ...
    var bi = {aes: 1, widevine: 2, playready: 3, fairplay: 4}, Ti = {
        interaction: 1,
        autostart: 2,
        repeat: 3,
        external: 4,
        ...
        "related-auto": 5,
        playlist: 6
    }, Ci = {none: 1, metadata: 2, auto: 3}, Si = function () {
        function t(e) {
            Gn(this, t), this._api = e, this.previousBufferTime = this.getTotalUnderBufferTime()
        }
        ...
        return t.prototype.getTotalUnderBufferTime = function () {
            ...
            var t = !(0 < arguments.length && void 0 !== arguments[0]) || arguments[0], e = this.getTotalUnderBufferTime(), n = Math.round(e - this.previousBufferTime);
            return t && (this.previousBufferTime = e), n
        }, t
    }(), Pi = function () {
        function t(e) {
            Gn(this, t), this._generateTrackingFunc = e, this._numTrackedSeeks = 0, this._setupTrackingParams()
        }
        ...
        return t.prototype._isTrackingSeek = function () {
            ...
            this._trackingParams = {videoStartDragTime: 0, dragStartTime: 0, seekDebounceTimeout: -1, lastTargetTime: 0}
        }, t.prototype._resetSeekData = function () {
            this._setupTrackingParams(), this._numTrackedSeeks = 0
        }, t
    }(), Ii = Math.floor, _i = Math.round, Ai = "play", xi = "meta", Ri = "levels", ji = "firstFrame", Di = v(12), Li = 0, Mi = function (i, h) {
        function g(t) {
            t = t || o(i);
            var e, n = u(i), a = wi(i), c = Yn(), d = i.getConfig(), f = d.visibility, l = N.isUndefined(f) ? f : _i(100 * f) / 100, h = d.defaultPlaybackRate;
            ...
            nt && v.push(Kn(Qn, pt[Qn], 49), Kn(Bn, pt[Bn], 50), Kn(Hn, pt[Hn], 51), Kn(Un, pt[Un], 52), Kn(Vn, pt[Vn], 53), Kn(Xn, pt[Xn], 54), Kn(Nn, pt[Nn], 55), Kn(Wn, pt[Wn], 56)), N.isUndefined(e) || v.push(Kn(we, e, 41));
            var g = d.ab;
            if (g && g.tests) {
        ...
        function k(t) {
            De.playReason = t.playReason || "", De.mediaId = I(t.item || o(i)), L() && q()
        }
        ...
        function B(t, e, n) {
            t = Ii(t), e = Ii(e), n = Ii(n);
            var i = e - t;
            return 0 == i ? function () {
                } : Me.track.bind(Me, ct, tt, [Kn(nn, t, 20), Kn(rn, e, 21), Kn(an, i, 22), Kn(on, n, 23)].concat(g()))
        }
        ...
        var N = i._, W = i.utils, et = !0 === h.debug, nt = parseInt(h.sdkplatform, 10), dt = i.getConfig(), st = li(dt.key, W.key), ft = gi(dt), lt = hi(nt), pt = vi(i, h, nt), ht = {};
        nt && (ht.cx = 0, ht.o = 0, ht.cs = 0, ht.pip = 0), Li += 1;
        var vt = Li, De = {
            ready: null,
            item: null,
            drm: "",
            ...
            mediaId: "",
            playReason: ""
        }, Le = this, Me = new si(h, et, i.getContainer());
        ei(Le, 0, 0, i, Me), ii(Le, i, Me);
        var qe, Fe, Ee, Oe, Be = 0, Ve = 0, Qe = null, He = new Si(i), Xe = !1, Ne = !1, We = !1, $e = 0, ze = 0;
        Le.getCommonTrackingParameters = function () {
            return g(o(i))
        }, H(g, i, Me.track.bind(Me)), ci(g, i, function () {
            L() && Me.track.apply(Me, arguments)
        }), Le.getPlaylistTrackingParameters = function () {
            return m(o(i))
        }, i.on("mobile-sdk-lt", function (t) {
            N.extend(ht, t)
        }), i.on("idle", S), i.on("ready", function (t) {
            De.ready = N.extend({}, t), De.item = o(i)
        }), i.on("playlistItem", function (t) {
            De.drm = "", De.itemId = v(12), ze++, De.index = t.index, De.ready && (F(De.item || o(i), De.ready), De.item = null, De.ready = null), i.off("beforePlay", k), i.once("beforePlay", k), S(), Ne = We = !1
        }), i.on("meta", j(xi)), i.on("levels", j(Ri)), i.on("play", j(Ai)), i.on("firstFrame", j(ji)), i.on("time", function (t) {
            var e = a(i), n = t.duration;
            if (e) {
                if (1 < e) {
                    if (!qe[xi]) {
                        var r = {duration: n}, o = i.getContainer().querySelector("video");
                        o && (r.width = o.videoWidth, r.height = o.videoHeight), j(xi)(r)
                    }
                    qe[Ri] || j(Ri)({})
                }
                var u = K(n), c = J(e, n, u);
                0 === Ee && (Ee = c), null === Qe && (Qe = e);
                var d = e - Qe;
        ...
        i.on("playbackRateChanged", function (t) {
            L() && Me.track("pru", tt, [Kn("ppr", dn, 20)].concat(Le.getCommonTrackingParameters())), dn = t.playbackRate
        }), S()
    };
